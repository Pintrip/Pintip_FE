    ...
    >
      ...
      <div className="w-full flex flex-col items-center">
        ...
        <div className="flex justify-center items-center gap-1.5 mt-3">
          <div
            className={`size-2 rounded-md ${activeIndex === 0 ? "bg-orange-6" : "bg-white"}`}
          />
          <div
            className={`size-2 rounded-md ${activeIndex === 1 ? "bg-orange-6" : "bg-white"}`}
          />
          <div
            className={`size-2 rounded-md ${activeIndex === 2 ? "bg-orange-6" : "bg-white"}`}
          />
        </div>
      </div>
      <Button
